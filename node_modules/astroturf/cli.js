...
function composesPlugin(css) {
  css.walkDecls('composes', decl => {
    const [, classes, rest = ''] = decl.value.match(/(.+?)(from.*)?$/); // eslint-disable-next-line no-param-reassign
...
async function handler({
  ...
  async function runAstroturf(content, file) {
    ...
    const result = (0, _loaders.collectStyles)(content, file, dependencyResolver, { ...(fileOptions == null ? void 0 : fileOptions.config),
      writeFiles: false,
      extension: '.css',
  ...
  for (const file of files) {
    ...
    await (0, _promises.writeFile)(file, (0, _loaders.replaceStyleTemplates)({}, file, content, changeset).code);
  }
