...
function peg$parse(input, options) {
  ...
  var peg$f2 = function(char) { return char; };
  var peg$f3 = function(ref) { return { name : ref, global : true }; };
  var peg$f4 = function(ref) { return { name : ref }; };
  var peg$f5 = function(head, ref) { return ref; };
  var peg$f6 = function(head, tail) { return [ head ].concat(tail); };
  var peg$f7 = function(source) {
          return source;
      };
  var peg$f8 = function(source) {
          return {
              type : "import",
              source,
          };
      };
  var peg$f9 = function(name, source) {
          return {
              type : "namespace",
              source,
              name,
  ...
  var peg$f10 = function(name, alias, source) {
          return {
              type : "alias",
              alias,
              source,
  ...
  var peg$f11 = function(ref, value) {
          return {
              type  : "assignment",
              name  : ref.name,
              value : value.join(""),
  ...
  var peg$f12 = function(refs, source) {
          return {
              type : "composition",
              source,
              refs,
